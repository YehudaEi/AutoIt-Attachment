...
;	EndFunc
	...
	Func TogglePause()
		$Paused = NOT $Paused
		$CheckPause = 1
		ToolTip("Program has been paused.",0,0)
	EndFunc
...
While 1
	...
	Case $msg = $Button3	;This make sure the program EXITS, when EXIT button is pressed.
		Exit
	
	Case $msg = $Button1	;The accept button for update rate
	...
	Case $msg = $Button2	;The accept button for Health/Power pots
	...
	;The entire program follows below
	
		If $CheckPause == 0 Then
			If $Program == 0 Then
