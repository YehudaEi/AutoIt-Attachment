...
;
; ;==========================================================================================
func _TesseractScreenCapture($get_last_capture = 0, $delimiter = "", $cleanup = 1, $scale = 2, $iLeft = 0, $iTop = 0, $iRight = 1, $iBottom = 1, $show_capture = 0, $iLumin = 127 )
	...
	CaptureToTIFF("", "", "", $capture_filename, $scale, $iLeft , $iTop , $iRight , $iBottom, 127)
	
	
	
	
	; ---------------- EDIT THIS LINE IF YOUR TESSERACT APPLICATION IS NOT LOCATED HERE! ---------------- 
...
Func CaptureToTIFF($win_title = "", $win_text = "", $ctrl_id = "", $sOutImage = "", $scale = 1, $iLeft = 0, $iTop = 0, $iRight = 1, $iBottom = 1, $iLumin = 127 )
	...
	$hImage2 = ChangeColors($hImage2, 0, 0, $iRight - $iLeft, $iBottom - $iTop, 127)
	;EndIf
...
Func ChangeColors($hImage2, $iStartPosX = 0, $iStartPosY = 0, $GuiSizeX = Default, $GuiSizeY = Default, $iLumin = 127)
