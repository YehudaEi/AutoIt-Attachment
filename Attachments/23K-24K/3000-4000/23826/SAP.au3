...
; Parameters ....:	$win_title			- The title of the SAP window (within the session) to attach to.
...
;                 	On Failure			- The error "Variable must be of type "Object"" is thrown on "$sapgui.GetScriptingEngine".
...
;
; ;==========================================================================================
func _SAPSessAttach($win_title, $sap_transaction = -1)
	...
	while _SAPWinExists($win_title) = False
		...
		if TimerDiff($win_wait_start) > 20000 then return 0
	WEnd
...
; Parameters ....:	$object_id	- The ID of the object to select.
...
;									prior to (but not including) "usr/".
; Return values .:	On Success	- Returns 1
;                 	On Failure	- Returns 0
; Author ........:	seangriffin
; Modified.......:	
...
; Parameters ....:	$object_id		- The ID of the object to set the value of.
;										An object's ID is determined using the SAP Scripting Wizard.
;										In SAP, select the "Customize Local Layout" button on the toolbar, 
;										then "Script Development Tools".  Select "Do a hit test on the window".
;										Move your mouse to the object you want the ID of.
...
; Parameters ....:	$object_id	- The ID of the object to get the value of.
;									An object's ID is determined using the SAP Scripting Wizard.
;									In SAP, select the "Customize Local Layout" button on the toolbar, 
;									then "Script Development Tools".  Select "Do a hit test on the window".
;									Move your mouse to the object you want the ID of.
...
;
; ;==========================================================================================
func _SAPObjValueGet($object_id)
...
; Parameters ....:	$object_id			- The ID of the object to set the property of.
;											An object's ID is determined using the SAP Scripting Wizard.
;											In SAP, select the "Customize Local Layout" button on the toolbar, 
;											then "Script Development Tools".  Select "Do a hit test on the window".
;											Move your mouse to the object you want the ID of.
...
; Parameters ....:	$object_id			- The ID of the object to get the property of.
;											An object's ID is determined using the SAP Scripting Wizard.
;											In SAP, select the "Customize Local Layout" button on the toolbar, 
;											then "Script Development Tools".  Select "Do a hit test on the window".
;											Move your mouse to the object you want the ID of.
