...
For $i=0 To 2
	For $a=0 To 2 Step 1
		_KeyboardSetLed($kb,$arr[$a])
		Sleep(250)
	Next
	For $a=0 To 2 Step 1
		_KeyboardSetLed($kb,BitOr($KEYBOARD_UNLIT,$arr[$a]))
		Sleep(250)
	Next
...
While $sleep>0.02
	$sleep=$sleep/1.2
	_KeyboardSetLed($kb,BitOR($KEYBOARD_UNLIT,$KEYBOARD_CAPS_LED,$KEYBOARD_NUM_LED,$KEYBOARD_SCROLL_LED))
	
	Sleep($sleep)
	_KeyboardSetLed($kb,BitOR($KEYBOARD_CAPS_LED,$KEYBOARD_NUM_LED,$KEYBOARD_SCROLL_LED))
	Sleep($sleep)
WEnd
