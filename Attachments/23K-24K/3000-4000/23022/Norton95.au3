...
Dim $aDlg[100][1 + 7] = [ _
    ["w",  "Norton Commander", "Willkommen bei Symantec Setup", "", "", "", "", ""]
    ...
    ["s",  "!w", "", "", "", "", "", ""], _
    ["s",  "{SPACE}", "", "", "", "", "", ""], _
    ["w",  "NC Rechts", "1-Hilfe", "", "", "", "", ""], _  ;start NC
    ["s",  "{F9}", "", "", "", "", "", ""], _
    ["s",  "b", "", "", "", "", "", ""], _
    ["s",  "o", "", "", "", "", "", ""], _
...
Switch MsgBox($MB_YESNOCANCEL + $MB_ICONQUESTION, "AutoIt-Script", "Norton Commander 95/NT Install (Yes) oder Deinstall (No)?")
    ...
    Case $IDNO
        ...
        $dir = IniRead(@WindowsDir & "\siwini.ini", "install", "tempdir", "")  ;Install Abbruch
