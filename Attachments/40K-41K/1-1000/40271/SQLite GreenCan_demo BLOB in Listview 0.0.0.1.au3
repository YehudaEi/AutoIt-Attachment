...
If @error Then
	...
	Exit
EndIf
Local $hListView = GUICtrlCreateListView("Key|Filename|TypeOfObject|Object|Title", 10, 10, $iGUIWidth -20, $iGUIHeigth - 50, $LVS_REPORT, $WS_EX_CLIENTEDGE)
...
GUICtrlSendMsg(-1, $LVM_SETCOLUMNWIDTH, 4, 315) ; Title
...
;~ _GUIImageList_AddIcon($hImage, @SystemDir & "\shell32.dll", 137) ; execute
;~ _GUIImageList_AddIcon($hImage, @SystemDir & "\shell32.dll", 301) ; image
			...
			Switch $iCode
				...
				Case $NM_CLICK
					...
					If $subitemNR = 3 Then
						...
						If $hFile = -1 Then
							MsgBox(48, "Error", "Unable to create export file " & $sFileName & @CR & "Please verify if your last Excel export is still open!")
							Return
						EndIf
						$iMaxRows = UBound($aResult)
						If $iMaxRows = 0 Then ; Bob contains less than 4094 bytes
