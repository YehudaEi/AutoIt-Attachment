...
Dim $serverArr[5][2] = [ _
		[String("scalaserver"), String("10.0.0.1")], _
		[String("serverbkuphq"), String("10.0.0.4")], _
		[String("carvm1"), String("10.0.0.6")], _
		[String("intranetserver"), String("10.0.0.8")], _
		[String("server1"), String("10.0.0.9")]]

$hostfile = @DesktopDir & '\hosts.ini'

$s = UBound($serverArr) - 1; get zize of array just take some leg work out of the for next loops, i'm quit lazy
...
; this is not called as yet, only working as standalone routine utile i can workout how to intergrate it.
