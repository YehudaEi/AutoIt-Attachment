...
;===============Function Tam ngung chuong trinh thuc thi
Func TogglePause()
	$Paused = NOT $Paused
	While $Paused
		sleep (100)
		ToolTip ('Chuong trinh dang tam ngung, nhan "Pause" de tiep tuc', 0, 0)
	WEnd
	ToolTip ("")
EndFunc   ;==>TogglePause
;=====================================================

;===============Function Ket thuc chuong trinh========
Func Terminate()
	Exit 0
EndFunc   ;==>Terminate
;=====================================================
...
;Global $Game_ID=0x00000284
 
Global $Game_ID="GAME.EXE"
;$PID = ProcessExists($Game_ID)
;Game_ID="0x"&Hex($PID,8)
;sgBox(0, "Redalert as ", $Game_ID)

;MsgBox(0,"Address","0x"&Hex($PID,8))
...
;$Address=_MemoryRead($Pointer,$ID) +$Offset
;MsgBox(0,"Address",Hex($Address,8))
;$MaxMoney=_MemoryRead($Address,$ID)
;MsgBox(0,"Max Gold" ,$MaxMoney)
;_MemoryClose($ID)