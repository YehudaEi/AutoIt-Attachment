...
;~ 				DllCall ("user32.dll", "int", "PostMessage", "hwnd", GUICtrlGetHandle($rt[4]), "int", $WM_NCLBUTTONDOWN, "int", $HTCAPTION, "int", 0)			
				if $bExpanded[$rt[4]] Then
;~ 				DllCall ("user32.dll", "int", "ReleaseCapture")
;~ 					DllCall ("user32.dll", "int", "SendMessage", "hwnd", GUICtrlGetHandle($expid[$rt[4]]), "int", $WM_NCLBUTTONDOWN, "int", $HTCAPTION, "int", 0)			
