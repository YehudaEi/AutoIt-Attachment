...
$gui = GUICreate("Online Radio Jukebox", 230, 110, -1, -1, $WS_POPUP + $WS_SYSMENU + $WS_MINIMIZEBOX, $WS_EX_LAYERED)
...
Func About()
    GUISetState(@SW_HIDE)
	SplashTextOn("About", "Online Radio Jukebox" & @CRLF & "Made with Autoit" & @CRLF & "Listen to Online Radio" & @CRLF & "Play your mp3/wma" & @CRLF & "Boenders Jos", 190, 100, -1, -1, 1, "", 12)
    Sleep(10000)
    SplashOff()
    GUISetState(@SW_SHOW)
EndFunc
