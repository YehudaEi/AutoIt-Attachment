...
DllStructSetData($WAVEHDR,"lpData",DllStructGetPtr($CharStruct_Of_lpData))
...
$RegisterProc = DllCallbackRegister("waveInProc","none","ptr;uint;ptr;ptr;ptr") 
...
Func waveInProc($hwi,$uMsg,$dwInstance,$dwParam1,$dwParam2)
Local _
$MM_WOM_OPEN = 0x3BB , _
...
if Not ($MMRESULT[0] = 0) Then Return SetError(1,$MMRESULT[0],0)
Return SetError(0,0,$MMRESULT[1])
EndFunc
