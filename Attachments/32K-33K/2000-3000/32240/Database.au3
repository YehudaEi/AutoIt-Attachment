...
Global $_OneRec = "",$Record = "", $ViewForm,$NewForm,$c, $_row, $Recordnumber
$hGUI = GUICreate('Database Records', 800, 500)
		...
		While 1
			...
			Select
				...
				Case $_msg[0] = $NButton4
					...
					GUICtrlRead($NInput6) & "--" &  GUICtrlRead($NInput7) & "--" &  GUICtrlRead($NInput8) & "--" &  GUICtrlRead($NInput9) & "--" &  GUICtrlRead($NInput10) & "--" &  GUICtrlRead($NInput11) & "--" & _
					GUICtrlRead($NInput12) & "--" &  GUICtrlRead($NInput13) & "--" &  GUICtrlRead($NInput14) & "--" &  GUICtrlRead($NInput15) & "--" &  GUICtrlRead($NInput16) & "--" &  GUICtrlRead($NInput17) & "--" & _
					GUICtrlRead($NInput18) & "--" &  GUICtrlRead($NInput19) & "--" &  GUICtrlRead($NInput20) & "--" &  GUICtrlRead($NInput21) & "--" &  GUICtrlRead($NInput22) & "--" &  GUICtrlRead($NInput23) & "--" & _
					GUICtrlRead($NInput24) & "--" &  GUICtrlRead($NInput25) & "--" &  GUICtrlRead($NInput26) & "--" &  GUICtrlRead($NInput27) & "--" &  GUICtrlRead($NInput28) & "--" &  GUICtrlRead($NInput29) 
...
_GUICtrlListView_InsertColumn ($hListView,0,  "ID", 15)
...
; Add items
	for $i = 1 to UBound($_Records) - 1
		...
		$Fields = StringSplit($_Records[$i],"--",1)
		$ID = $Fields[1]
		$LName = $Fields[2]
		$FName = $Fields[3]
		$MName = $Fields[4]
