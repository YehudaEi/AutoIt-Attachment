...
; Language ......: English
; Description ...: Creates a simple viewable database on a txt file.
; Author(s) .....: Ace08
; ===============================================================================================================================
...
$hGUI = GUICreate('Simple Database', 800, 500)
...
$file = FileOpen("C:\DataBase\DBaseList.txt", 8)

If $file = -1 Then
	DirCreate("C:\DataBase")
	$file = FileOpen("C:\DataBase\DBaseList.txt", 10)
			...
			Select
				...
				Case $msg[0] = $Button2
					...
					Else
						...
						Next
						FileDelete("C:\DataBase\DBaseList.txt")
						sleep(50)
						$Sfile = FileOpen("C:\DataBase\DBaseList.txt", 10)
		...
		While 1
			...
			Select
				...
				Case $_msg[0] = $NButton4
					...
					$file = FileOpen("C:\DataBase\DBaseList.txt", 1)
...
Func DeleteItem()
    ...
    Case 6; 6 value for button Yes
		...
		FileDelete("C:\DataBase\DBaseList.txt")
		sleep(50)
		$SDfile = FileOpen("C:\DataBase\DBaseList.txt", 10)
		; Check if file opened for reading OK
		If $SDfile = -1 Then
