...
#AutoIt3Wrapper_Icon=Wizard.ico                  			;Filename of the Ico file to use
...
#AutoIt3Wrapper_Res_Field=Email|custompcs@charter.net 	;Free format fieldname|fieldvalue
#AutoIt3Wrapper_Res_Field=Release Date|1/15/2006  		;Free format fieldname|fieldvalue
#AutoIt3Wrapper_Res_Field=Update Date|6/27/2014			;Free format fieldname|fieldvalue
#AutoIt3Wrapper_Res_Field=Internal Name|CodeWizard.exe 	;Free format fieldname|fieldvalue
#AutoIt3Wrapper_Res_Field=Status|Prod 					;Free format fieldname|fieldvalue
#AutoIt3Wrapper_Run_AU3Check=y        					;Run au3check before compilation
#AutoIt3Wrapper_Run_Tidy=y
#AutoIt3Wrapper_Run_Au3Stripper=y
#Au3Stripper_Parameters=
#AutoIt3Wrapper_Run_After_Admin=y
#AutoIt3Wrapper_Run_After=for %I in ("%in%" "%out%") do copy %I "%programfiles%\autoit3\SciTE\CodeWizard"
...
If (Not FileExists($CodeWizardIniPath & "\colors.ini")) Then
	...
	MsgBox(48, "File Not Found", "Required file not found (" & $CodeWizardIniPath & "\colors.ini" & ")" & @CRLF & "" & @CRLF & "CodeWizard will now exit!!!")
	#EndRegion --- CodeWizard generated code Start ---
	Exit
EndIf

$T_STR = ""
$ARRAY = IniReadSection($CodeWizardIniPath & "\colors.ini", "SCHEMES")
If @error Then
	MsgBox(4096, "Error occured", ", Error reading : " & $CodeWizardIniPath & "\colors.ini file.")
	Exit
Else
...
;==================================================================
$CONTROL_ID_WINDOW = GUICreate("Control ID", $W_WIDTH - 5, 40, 0, 0, $WS_CHILD + $WS_DLGFRAME, -1, $MAIN_WINDOW)
$LBL_CFC = GUICtrlCreateLabel("Control ID (Font/Cursor/Control Color):", 10, 10, 180, 15, $SS_RIGHT)
$CTLID = GUICtrlCreateInput("", 190, 8, 130, 20)
GUICtrlSetTip($CTLID, 'Enter the Control ID Name')
$CTL_INCLUDE_COMMENTS = GUICtrlCreateCheckbox("Include Comment Block", 350, 10, 150, 20)
GUICtrlSetTip($CTL_INCLUDE_COMMENTS, 'Comments/Description from Help file')
$CTLTESTINPUT = GUICtrlCreateButton("Enter Example Text", 500, 10, 120, 20)
...
$btnTitle = GUICtrlCreateButton("&Title", 10, 510, 100)
GUICtrlSetTip($btnTitle, "Find the Script Title")
$btnPreview = GUICtrlCreateButton("&Preview", 120, 510, 100)
GUICtrlSetTip($btnPreview, "Show the MessageBox/Dialog Box")
$btnCopy = GUICtrlCreateButton("&Copy 2 SciTE", 230, 510, 100)
...
$btnExit = GUICtrlCreateButton("&Exit", 340, 510, 100)
...
;==================================================================
$tabToolTip = GUICtrlCreateTabItem("ToolTip")
...
$chkSTTitle = GUICtrlCreateCheckbox("Title Bar", 30, 50, 60, 20)
...
$chkSTOnTop = GUICtrlCreateCheckbox("Always On Top", 30, 230, 150, 20)
...
$btnSTFonts = GUICtrlCreateButton("Choose", 360, 355, 70, 20)
...
$chkSITitle = GUICtrlCreateCheckbox("Title Bar", 30, 70, 60, 20)
GUICtrlSetTip(-1, "With Title Bar/Thin bordered titleless window")
$lblSITitle = GUICtrlCreateLabel("Title", 30, 100, 20)
GUICtrlSetState(-1, $GUI_DISABLE)
$txtSITitle = GUICtrlCreateInput("", 60, 95, 210, 20)
GUICtrlSetTip(-1, "The Title of the splash window")
GUICtrlSetState(-1, $GUI_DISABLE)
GUICtrlSetState(-1, $GUI_FOCUS)
$chkSIWinMove = GUICtrlCreateCheckbox("Windows can be moved", 290, 100, 140, 20)
GUICtrlSetState(-1, $GUI_DISABLE)
GUICtrlCreateGroup("", -99, -99, 1, 1) ;close group
...
GUICtrlSetTip(-1, "The Text of the splash window")
$btnSIImage = GUICtrlCreateButton("Open", 370, 190, 70, 20)
GUICtrlSetTip(-1, "Show the Open File dialog box")

;Options Group
GUICtrlCreateGroup("Options", 20, 260, 420, 60)
$chkSIOnTop = GUICtrlCreateCheckbox("Always On Top", 60, 290, 150, 20)
GUICtrlSetTip(-1, 'Set the "Always On Top" attribute')
...
;==================================================================
$TAB_COLOR = GUICtrlCreateTabItem("Colors")
...
$CTLTEXTCOLOR = GUICtrlCreateButton("Set Text Color", 35, 110, 90, 20)
...
$CTLBACKCOLOR = GUICtrlCreateButton("Set Back Color", 35, 140, 90, 20)
...
$CREATE_GUICTRLSETCOLOR = GUICtrlCreateButton("Create GUICtrlSetColor", 65, 315, 130, 20)
...
$CREATE_GUICTRLSETBKCOLOR = GUICtrlCreateButton("Create GUICtrlSetBkColor", 65, 345, 130, 20)
...
$CREATE_GUISETBKCOLOR = GUICtrlCreateButton("Create GUISetBkColor", 285, 315, 130, 20)
...
;==================================================================
$TAB_FONTS_CURSORS = GUICtrlCreateTabItem("Control Fonts/Cursors")
$GROUP[2] = GUICtrlCreateGroup("Set Font", 40, 60, 175, 130)
GUICtrlSetFont($GROUP[2], 9, 600, -1, "Times New Roman")
$CTRLSELECTFONTS = GUICtrlCreateButton("Choose", 90, 80, 70, 20)
...
$LV_FILELIST = GUICtrlCreateListView("Name|Hex Value", 17, 120, 215, $W_HEIGHT - 202, BitOR($LVS_SINGLESEL, $LVS_SHOWSELALWAYS, $LVS_NOSORTHEADER), BitOR($LVS_EX_GRIDLINES, $LVS_EX_FULLROWSELECT, $LVS_EX_HEADERDRAGDROP, $LVS_EX_REGIONAL))
