;CaptainClucks aka THAT1ANONYMOUSDUDE aka ApudAngelorum at MarlboroLoco at gmail.com
;Credits to Yashied, monoceres, wraithdu, Manko, Trancexx, Larry, SmOke_N, mrRevoked, guinness.
...
Global $ReturnInf = _UnlockFile(0, @ScriptDir & "\text.txt"); will unlock the directory our script is in..
...
; to look for handles in only a particular process, add it's PID in place of "0"..

Func _UnlockFile($PID, $FileToUnlock); Filetounlock variable can be an array of files.
    If $PID Then
...
Func _ProcessGetPath($vProcess); forgot who made this
...
Func AdjustPrivilege($Type);manko's originally
