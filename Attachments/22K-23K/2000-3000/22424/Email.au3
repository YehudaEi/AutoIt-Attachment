...
$s_FromAddress = "something@something.com" 		; address from where the mail should come
$s_ToAddress = "it@there.com"   				; destination address of the email - REQUIRED
$s_Subject = "Backups were checked."            ; subject from the email - can be anything you want it to be
