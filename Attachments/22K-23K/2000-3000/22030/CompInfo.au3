...
#comments-start
	...
	Author:			Jarvis J. Stubblefield (JSThePatriot)                                  
	Contributer:  	mrRevoked
	Version:		00.03.08
...
If Not(IsDeclared("cI_objWMIService")) 	Then 	Global $cI_objWMIService = 0
...
;===============================================================================
; Description:      Initiates the WMI object into memory
; Parameter(s):     None
; Requirement(s):   None
; Return Value(s):  On Success - Returns 1
;                   On Failure - @error = 1 and Returns 0
;								 @extended = 1 - WMI Object already initiated
;											 2 - Failed
;							
; Author(s):       mrRevoked
; Note(s):
;===============================================================================
Func _ComputerGetInit()
	If $cI_objWMIService Then Return SetError(1, 1, 0)
	Dim $cI_objWMIService = ObjGet("winmgmts:\\" & $cI_Compname & "\root\CIMV2")
	If IsObj($cI_objWMIService) Then Return 1
	Return SetError(1, 2, 0)
EndFunc

;===============================================================================
; Description:      Removes the WMI object from memory
; Parameter(s):     None
; Requirement(s):   None
; Return Value(s):  None
;							
...
; Note(s):
;===============================================================================
Func _ComputerGetEnd()
	If $cI_objWMIService = 0 Then Return
	Dim $cI_objWMIService = 0
EndFunc
...
;											3 - $cI_objWMIService isnt an object
; Author(s):        Jarvis Stubblefield (support "at" vortexrevolutions "dot" com)
; Modified : 		mrRevoked
; Note(s):
;===============================================================================
Func _ComputerGetBootConfig()
	Local $colItems, $objItem
	Dim $aBootConfigInfo[1][8], $i = 1
	
	If $cI_objWMIService = 0 Then _ComputerGetInit()
	If Not IsObj($cI_objWMIService) Then Return SetError(1, 3, 0)
	$colItems = $cI_objWMIService.ExecQuery("SELECT * FROM Win32_BootConfiguration", "WQL", $wbemFlagReturnImmediately + $wbemFlagForwardOnly)
...
; Note(s):
;===============================================================================
Func _ComputerGetDependantServices()
	Local $colItems, $objItem
	Dim $aDependantServiceInfo[1][3], $i = 1

	If $cI_objWMIService = 0 Then _ComputerGetInit()
	If Not IsObj($cI_objWMIService) Then Return SetError(1, 3, 0)
	$colItems = $cI_objWMIService.ExecQuery("SELECT * FROM Win32_DependentService", "WQL", $wbemFlagReturnImmediately + $wbemFlagForwardOnly)
...
; Note(s):
;===============================================================================
Func _ComputerGetDesktops()
	Local $colItems, $objItem
	Dim $aDesktopInfo[1][20], $i = 1

	If $cI_objWMIService = 0 Then _ComputerGetInit()
	If Not IsObj($cI_objWMIService) Then Return SetError(1, 3, 0)
	$colItems = $cI_objWMIService.ExecQuery("SELECT * FROM Win32_Desktop", "WQL", $wbemFlagReturnImmediately + $wbemFlagForwardOnly)
...
; Note(s):
;===============================================================================
Func _ComputerGetEventLogs()
	Local $colItems, $objItem
	Dim $aEventLogInfo[1][38], $i = 1
	
	If $cI_objWMIService = 0 Then _ComputerGetInit()
	If Not IsObj($cI_objWMIService) Then Return SetError(1, 3, 0)
	$colItems = $cI_objWMIService.ExecQuery("SELECT * FROM Win32_NTEventLogFile", "WQL", $wbemFlagReturnImmediately + $wbemFlagForwardOnly)
...
; Note(s):
;===============================================================================
Func _ComputerGetExtensions()
	Local $colItems, $objItem
	Dim $aExtensionInfo[1][16], $i = 1
	
	If $cI_objWMIService = 0 Then _ComputerGetInit()
	If Not IsObj($cI_objWMIService) Then Return SetError(1, 3, 0)
	$colItems = $cI_objWMIService.ExecQuery("SELECT * FROM Win32_ExtensionInfoAction", "WQL", $wbemFlagReturnImmediately + $wbemFlagForwardOnly)
...
; Note(s):
;===============================================================================
Func _ComputerGetGroups()
	Local $colItems, $objItem
	Dim $aGroupInfo[1][7], $i = 1
	
	If $cI_objWMIService = 0 Then _ComputerGetInit()
	If Not IsObj($cI_objWMIService) Then Return SetError(1, 3, 0)
	$colItems = $cI_objWMIService.ExecQuery("SELECT * FROM Win32_Group", "WQL", $wbemFlagReturnImmediately + $wbemFlagForwardOnly)
...
; Note(s):
;===============================================================================
Func _ComputerGetLoggedOnUsers()
	Local $colItems, $objItem
	...
	If $cI_objWMIService = 0 Then _ComputerGetInit()
	If Not IsObj($cI_objWMIService) Then Return SetError(1, 3, 0)
	$colItems = $cI_objWMIService.ExecQuery("SELECT * FROM Win32_LoggedOnUser", "WQL", $wbemFlagReturnImmediately + $wbemFlagForwardOnly)
...
Func _ComputerGetOSs()
	...
	If $cI_objWMIService = 0 Then _ComputerGetInit()
	If Not IsObj($cI_objWMIService) Then Return SetError(1, 3, 0)
	$colItems = $cI_objWMIService.ExecQuery("SELECT * FROM Win32_OperatingSystem", "WQL", $wbemFlagReturnImmediately + $wbemFlagForwardOnly)
...
; Note(s):
;===============================================================================
Func _ComputerGetPrintJobs()
	Local $colItems, $objItem
	Dim $aPrintJobInfo[1][23], $i = 1

	If $cI_objWMIService = 0 Then _ComputerGetInit()
	If Not IsObj($cI_objWMIService) Then Return SetError(1, 3, 0)
	$colItems = $cI_objWMIService.ExecQuery("SELECT * FROM Win32_PrintJob", "WQL", $wbemFlagReturnImmediately + $wbemFlagForwardOnly)
...
; Note(s):
;===============================================================================
Func _ComputerGetProcesses()
	Local $colItems, $objItem
	Dim $aProcessInfo[1][42], $i = 1
	
	If $cI_objWMIService = 0 Then _ComputerGetInit()
	If Not IsObj($cI_objWMIService) Then Return SetError(1, 3, 0)
	$colItems = $cI_objWMIService.ExecQuery("SELECT * FROM Win32_Process", "WQL", $wbemFlagReturnImmediately + $wbemFlagForwardOnly)
...
; Parameter(s):     $sState - OPTIONAL - Accepted values 'All' or 'Stopped' or
;										'Running'
; Requirement(s):   None
...
; Note(s):
;===============================================================================
Func _ComputerGetServices($sState = "All")
	...
	If $cI_objWMIService = 0 Then _ComputerGetInit()
	If Not IsObj($cI_objWMIService) Then Return SetError(1, 3, 0)
	$colItems = $cI_objWMIService.ExecQuery("SELECT * FROM Win32_Service", "WQL", $wbemFlagReturnImmediately + $wbemFlagForwardOnly)
...
; Note(s):
;===============================================================================
Func _ComputerGetShares()
	Local $colItems, $objItem
	Dim $aShareInfo[1][8], $i = 1
	
	If $cI_objWMIService = 0 Then _ComputerGetInit()
	If Not IsObj($cI_objWMIService) Then Return SetError(1, 3, 0)
	$colItems = $cI_objWMIService.ExecQuery("SELECT * FROM Win32_Share", "WQL", $wbemFlagReturnImmediately + $wbemFlagForwardOnly)
...
Func _ComputerGetStartup()
	...
	If $cI_objWMIService = 0 Then _ComputerGetInit()
	If Not IsObj($cI_objWMIService) Then Return SetError(1, 3, 0)
	$colItems = $cI_objWMIService.ExecQuery("SELECT * FROM Win32_StartupCommand", "WQL", $wbemFlagReturnImmediately + $wbemFlagForwardOnly)
...
; Note(s):
;===============================================================================
Func _ComputerGetThreads()
	Local $colItems, $objItem
	Dim $aThreadInfo[1][20], $i = 1
	
	If $cI_objWMIService = 0 Then _ComputerGetInit()
	If Not IsObj($cI_objWMIService) Then Return SetError(1, 3, 0)
	$colItems = $cI_objWMIService.ExecQuery("SELECT * FROM Win32_Thread", "WQL", $wbemFlagReturnImmediately + $wbemFlagForwardOnly)
...
Func _ComputerGetUsers()
	...
	If $cI_objWMIService = 0 Then _ComputerGetInit()
	If Not IsObj($cI_objWMIService) Then Return SetError(1, 3, 0)
	$colItems = $cI_objWMIService.ExecQuery("SELECT * FROM Win32_UserAccount", "WQL", $wbemFlagReturnImmediately + $wbemFlagForwardOnly)
...
; Note(s):
;===============================================================================
Func _ComputerGetBattery()
	Local $colItems, $objItem
	Dim $aBatteryInfo[1][31], $i = 1

	If $cI_objWMIService = 0 Then _ComputerGetInit()
	If Not IsObj($cI_objWMIService) Then Return SetError(1, 3, 0)
	$colItems = $cI_objWMIService.ExecQuery("SELECT * FROM Win32_Battery", "WQL", $wbemFlagReturnImmediately + $wbemFlagForwardOnly)
...
; Note(s):
;===============================================================================
Func _ComputerGetBIOS()
	Local $colItems, $objItem
	Dim $aBIOSInfo[1][25], $i = 1
	
	If $cI_objWMIService = 0 Then _ComputerGetInit()
	If Not IsObj($cI_objWMIService) Then Return SetError(1, 3, 0)
	$colItems = $cI_objWMIService.ExecQuery("SELECT * FROM Win32_BIOS", "WQL", $wbemFlagReturnImmediately + $wbemFlagForwardOnly)
...
; Parameter(s):     $sDriveType - 	Type of drive to return the information on.
...
; Note(s):
;===============================================================================
Func _ComputerGetDrives($sDriveType = "FIXED")
	Local $drive
...
Func _ComputerGetKeyboard()
	...
	If $cI_objWMIService = 0 Then _ComputerGetInit()
	If Not IsObj($cI_objWMIService) Then Return SetError(1, 3, 0)
	$colItems = $cI_objWMIService.ExecQuery("SELECT * FROM Win32_Keyboard", "WQL", $wbemFlagReturnImmediately + $wbemFlagForwardOnly)
...
Func _ComputerGetMemory()
	...
	If $cI_objWMIService = 0 Then _ComputerGetInit()
	If Not IsObj($cI_objWMIService) Then Return SetError(1, 3, 0)
	$colItems = $cI_objWMIService.ExecQuery("SELECT * FROM Win32_PhysicalMemory", "WQL", $wbemFlagReturnImmediately + $wbemFlagForwardOnly)
...
; Note(s):
;===============================================================================
Func _ComputerGetMonitors()
	Local $colItems, $objItem
	Dim $aMonitorInfo[1][26], $i = 1

	If $cI_objWMIService = 0 Then _ComputerGetInit()
	If Not IsObj($cI_objWMIService) Then Return SetError(1, 3, 0)
	$colItems = $cI_objWMIService.ExecQuery("SELECT * FROM Win32_DesktopMonitor", "WQL", $wbemFlagReturnImmediately + $wbemFlagForwardOnly)
...
Func _ComputerGetMotherboard()
	...
	If $cI_objWMIService = 0 Then _ComputerGetInit()
	If Not IsObj($cI_objWMIService) Then Return SetError(1, 3, 0)
	$colItems = $cI_objWMIService.ExecQuery("SELECT * FROM Win32_MotherboardDevice", "WQL", $wbemFlagReturnImmediately + $wbemFlagForwardOnly)
...
; Note(s):
;===============================================================================
Func _ComputerGetMouse()
	Local $colItems, $objItem
	Dim $aMouseInfo[1][31], $i = 1
	
	If $cI_objWMIService = 0 Then _ComputerGetInit()
	If Not IsObj($cI_objWMIService) Then Return SetError(1, 3, 0)
	$colItems = $cI_objWMIService.ExecQuery("SELECT * FROM Win32_PointingDevice", "WQL", $wbemFlagReturnImmediately + $wbemFlagForwardOnly)
...
; Note(s):
;===============================================================================
Func _ComputerGetNetworkCards()
	Local $colItems, $objItem
	Dim $aNetworkInfo[1][34], $i = 1
	
	If $cI_objWMIService = 0 Then _ComputerGetInit()
	If Not IsObj($cI_objWMIService) Then Return SetError(1, 3, 0)
	$colItems = $cI_objWMIService.ExecQuery("SELECT * FROM Win32_NetworkAdapter", "WQL", $wbemFlagReturnImmediately + $wbemFlagForwardOnly)
...
; Note(s):
;===============================================================================
Func _ComputerGetPrinters()
	Local $colItems, $objItem
	Dim $aPrinterInfo[1][85], $i = 1
	
	If $cI_objWMIService = 0 Then _ComputerGetInit()
	If Not IsObj($cI_objWMIService) Then Return SetError(1, 3, 0)
	$colItems = $cI_objWMIService.ExecQuery("SELECT * FROM Win32_Printer", "WQL", $wbemFlagReturnImmediately + $wbemFlagForwardOnly)
...
Func _ComputerGetProcessors()
	...
	If $cI_objWMIService = 0 Then _ComputerGetInit()
	If Not IsObj($cI_objWMIService) Then Return SetError(1, 3, 0)
	$colItems = $cI_objWMIService.ExecQuery("SELECT * FROM Win32_Processor", "WQL", $wbemFlagReturnImmediately + $wbemFlagForwardOnly)
...
; Note(s):
;===============================================================================
Func _ComputerGetSoundCards()
	Local $colItems, $objItem
	Dim $aSoundCardInfo[1][21], $i = 1
	
	If $cI_objWMIService = 0 Then _ComputerGetInit()
	If Not IsObj($cI_objWMIService) Then Return SetError(1, 3, 0)
	$colItems = $cI_objWMIService.ExecQuery("SELECT * FROM Win32_SoundDevice", "WQL", $wbemFlagReturnImmediately + $wbemFlagForwardOnly)
...
; Note(s):
;===============================================================================
Func _ComputerGetSystem()
	Local $colItems, $objItem
	Dim $aSystemInfo[1][52], $i = 1
	
	If $cI_objWMIService = 0 Then _ComputerGetInit()
	If Not IsObj($cI_objWMIService) Then Return SetError(1, 3, 0)
	$colItems = $cI_objWMIService.ExecQuery("SELECT * FROM Win32_ComputerSystem", "WQL", $wbemFlagReturnImmediately + $wbemFlagForwardOnly)
...
; Note(s):
;===============================================================================
Func _ComputerGetSystemProduct()
	Local $colItems, $objItem
	Dim $aSysProductInfo[1][7], $i = 1
	
	If $cI_objWMIService = 0 Then _ComputerGetInit()
	If Not IsObj($cI_objWMIService) Then Return SetError(1, 3, 0)
	$colItems = $cI_objWMIService.ExecQuery("SELECT * FROM Win32_ComputerSystemProduct", "WQL", $wbemFlagReturnImmediately + $wbemFlagForwardOnly)
...
; Note(s):
;===============================================================================
Func _ComputerGetVideoCards()
	Local $colItems, $objItem
	Dim $aVideoInfo[1][59], $i = 1
	
	If $cI_objWMIService = 0 Then _ComputerGetInit()
	If Not IsObj($cI_objWMIService) Then Return SetError(1, 3, 0)
	$colItems = $cI_objWMIService.ExecQuery("SELECT * FROM Win32_VideoController", "WQL", $wbemFlagReturnImmediately + $wbemFlagForwardOnly)
