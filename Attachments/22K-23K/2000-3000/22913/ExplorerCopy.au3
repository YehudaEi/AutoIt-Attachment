...
;~ $file1 = @DesktopDir & "\chilit\data1.dat"
;~ $file2 = @DesktopDir & "\chilit\setup.exe"
;~ $n = _ExplorerCopy($file1, "C:\", BitOR($FOF_SIMPLEPROGRESS, $FOF_ALLOWUNDO))
;~ MsgBox(0,"Testing","Success = " & $n & @LF & "Error = " & @error)
...
Func _ExplorerCopy($source, $dest, $Options = 0)
    ...
    If @error Then
        MsgBox(48,"ERROR _ExplorerCopy line 39","Error creating SHFILEOPSTRUCT structure")
        Return False
    EndIf
    ...
    If _SHFileOperation($SHFILEOPSTRUCT) Then
        ...
        If @error Then MsgBox(48,"Error _ExplorerCopy line 65","Error calling GetLastError")
        SetError($aDllRet[0])
        Return False
...
Func _ExplorerMove($source, $dest, $Options = 0)
    ...
    $SHFILEOPSTRUCT = DllStructCreate("int;uint;ptr;ptr;uint;int;ptr;ptr")
    If @error Then
        MsgBox(48,"ERROR _ExplorerMove line 82","Error creating SHFILEOPSTRUCT structure")
        Return False
    EndIf
    ...
    If _SHFileOperation($SHFILEOPSTRUCT) Then
        $aDllRet = DllCall("kernel32.dll", "long", "GetLastError")
        If @error Then MsgBox(48,"Error _ExplorerMove line 108","Error calling GetLastError")
        SetError($aDllRet[0])
        Return False
    ElseIf DllStructGetData($SHFILEOPSTRUCT,$fAnyOperationsAborted) Then
        MsgBox(0,"Testing","Operation aborted")
...
Func _ExplorerDelete($path, $Options = 0)
    ...
    $SHFILEOPSTRUCT = DllStructCreate("int;uint;ptr;ptr;uint;int;ptr;ptr")
    If @error Then
        MsgBox(48,"ERROR _ExplorerDelete line 126","Error creating SHFILEOPSTRUCT structure")
        Return False
    EndIf
    ...
    If _SHFileOperation($SHFILEOPSTRUCT) Then
        $aDllRet = DllCall("kernel32.dll", "long", "GetLastError")
        If @error Then MsgBox(48,"Error _ExplorerDelete line 148","Error calling GetLastError")
        SetError($aDllRet[0])
        Return False
    ElseIf DllStructGetData($SHFILEOPSTRUCT,$fAnyOperationsAborted) Then
        MsgBox(0,"Testing","Operation aborted")
...
Func _ExplorerRename($old_name, $new_name, $Options = 0)
    ...
    $SHFILEOPSTRUCT = DllStructCreate("int;uint;ptr;ptr;uint;int;ptr;ptr")
    If @error Then
        MsgBox(48,"ERROR_ExplorerRename line 166","Error creating SHFILEOPSTRUCT structure")
        Return False
    EndIf
    ...
    If _SHFileOperation($SHFILEOPSTRUCT) Then
        $aDllRet = DllCall("kernel32.dll", "long", "GetLastError")
        If @error Then MsgBox(48,"Error _ExplorerRename line 192","Error calling GetLastError")
        SetError($aDllRet[0])
        Return False
    ElseIf DllStructGetData($SHFILEOPSTRUCT,$fAnyOperationsAborted) Then
        MsgBox(0,"Testing","Operation aborted")
