...
Global $position_slider_drag = False, $vlc1, $position_slider, $user_stop = False, $main_gui, $video_path_input, $target_filenames_to_burn = ""
...
GUICtrlSetLimit($constant_quantizer, 4, 1)
...
Func refresh()
	...
	if @error < 1 Then
		...
		dim $num_unconverted_files = $num_source_files
		...
		dim $target_filename = _FileListToArray(GUICtrlRead($source_folder_input), "*.mpg")
