...
RegWrite('HKCR\Mcat\shell\open\command\', '', 'REG_SZ', @ProgramFilesDir & '\Meerecat File Guard\Meerecat File Guard.exe "%1"')
	...
	While 1
		...
		Switch $nMsg
			Case $GUI_EVENT_CLOSE
				_main()
			Case $Label4
				ShellExecute("http://www.meerecat-itservices.co.uk")
			Case $Label5
				ShellExecute("http://www.meerecat-itservices.co.uk")
		EndSwitch
	WEnd
