...
$Label3 = GUICtrlCreateLabel("Recieved Data: ", 8, 110, 82, 17)
$Label4 = GUICtrlCreateLabel("Label4", 8, 24, 132, 17)
$Label5 = GUICtrlCreateLabel("Label5", 8, 56, 132, 17)
$Label6 = GUICtrlCreateLabel("Waiting For Connections...", 8, 128, 132, @DesktopHeight)
$Label7 = GUICtrlCreateLabel("_TCPIPToName", 8, 74, 132, 17)
$Label8 = GUICtrlCreateLabel("No data yet", 8, 92, 132, 17)
GUISetState(@SW_SHOW)
