...
#AutoIt3Wrapper_Res_Field=AutoIt Version|%AutoItVe#region ---Au3Recorder generated code Start (v3.3.7.0)  ---

Run('C:\Program Files\Internet Explorer\iexplore.exe')
_WinWaitActivate("SwagBucks TV - -The Knot - Windows Internet Explorer","")
MouseMove(1019,191)
MouseDown("left")
MouseMove(1020,393)
MouseUp("left")
MouseClick("left",156,234,1)
_WinWaitActivate("How Much Do Wedding Cakes Really Cost - Swagbucks TV - Windows Internet Explorer","")
MouseClick("left",746,656,1)
_WinWaitActivate("Unique Wedding Centerpiece Ideas - Swagbucks TV - Windows Internet Explorer","")
MouseClick("left",794,662,1)
_WinWaitActivate("How to Add Texture to Your Wedding Decor - Swagbucks TV - Windows Internet Explorer","")
MouseClick("left",892,658,1)
#endregion --- Au3Recorder generated code End ---

#region ---Au3Recorder generated code Start (v3.3.7.0)  ---

Run('C:\Program Files\Internet Explorer\iexplore.exe')
_WinWaitActivate("SwagBucks TV - -The Knot - Windows Internet Explorer","Address Combo Contro")
MouseMove(1016,168)
MouseDown("left")
MouseMove(1002,328)
MouseUp("left")
MouseClick("left",109,375,1)
_WinWaitActivate("How Much Do Wedding Cakes Really Cost - Swagbucks TV - Windows Internet Explorer","Address Combo Contro")
MouseMove(1017,277)
MouseDown("left")
MouseMove(1018,301)
MouseUp("left")
...
MouseMove(515,576)
MouseUp("left")
MouseClick("left",717,589,1)
#endregion --- Au3Recorder generated code End ---

r%
#AutoIt3Wrapper_Res_Field=Compile Date|%date% %time%
#AutoIt3Wrapper_Run_After=copy "%in%" "..\..\Programs_Updates\SciTEConfig\*.*"
#AutoIt3Wrapper_Run_After=copy "%out%" "..\..\Programs_Updates\SciTEConfig\*.*"
#AutoIt3Wrapper_Run_After=copy "%out%" "C:\Program Files (x86)\AutoIt3\SciTE\SciTEConfig\*.*"
#AutoIt3Wrapper_Run_After=copy "%in%" "C:\Program Files (x86)\AutoIt3\SciTE\SciTEConfig\*.*"
...
;$BaseY = 148
$H_Background_Label = GUICtrlCreateLabel("Background Color:" & StringLower($Background_Color), $BaseX + 5, $BaseY - 20, 150, 20)
$H_CaretLine_Label = GUICtrlCreateLabel("Caret line Color:" & StringLower($CaretLine_Color), $BaseX + 5, $BaseY, 150, 20)
...
$H_Background_Color = GUICtrlCreateButton("BackGround", $BaseX + 170, $BaseY - 20, 80, 20)
$H_CaretLine_Color = GUICtrlCreateButton("CaretLine", $BaseX + 170, $BaseY, 80, 20)
...
$H_Update = GUICtrlCreateButton("Save+Apply", 10, 470, 70)
