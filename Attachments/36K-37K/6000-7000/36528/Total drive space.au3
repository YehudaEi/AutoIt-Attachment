...
Else
    For $i = 1 To $aArray[0]
		...
		Local $iFreeSpace = DriveSpaceTotal ($drive & "\") ; Find the Total disk space of the home drive, generally this is the C:\ drive.
		$iFreeSpacegb = $iFreeSpace / 1000
		$iFreeSpacegb2 = Round ( $iFreeSpacegb ,2)
		MsgBox(4096, "Total Space:" & $drive, $iFreeSpacegb2 & " GB")
    Next
EndIf
