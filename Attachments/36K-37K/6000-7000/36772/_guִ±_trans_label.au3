...
_Fofff()
Func _Fofff()
Global $Input2,$Input1,$exititem_2,$exititem_1,$exititem
...
; Make a GUI
Global $iWidthGUI = 334
Global $iHeightGUI = 118
Global $Form1 = GUICreate("[#]Timer start[#]", $iWidthGUI, $iHeightGUI, -1, -1, $WS_OVERLAPPEDWINDOW)
...
$Button1 = GUICtrlCreateButton("START", 256, 24, 57, 41, $WS_GROUP)
...
; Enabling OpenGL
If Not _EnableOpenGL($Form1, $hDC, $hRC) Then
...
$Label1121 = GUICtrlCreateLabel("TÝME OVER !", (@DesktopWidth/2)-100, (@DesktopHeight/2)-100, 207, 41, $SS_CENTER)
GUICtrlSetFont(-1, 24, 800, 0, "MS Sans Serif")
GUICtrlSetBkColor(-1, $GUI_BKCOLOR_TRANSPARENT)
GUICtrlSetColor(-1, 0xFFFFFF)
sleep(500)
  $Button2123 = GUICtrlCreateLabel("EXÝT", (@DesktopWidth/2)-50, (@DesktopHeight/2)-30, 92, 25, BitOR($SS_CENTER,$WS_BORDER), $WS_EX_CLIENTEDGE)
GUICtrlSetCursor (-1, 0)
...
; Handling things on Exit
;GUISetOnEvent(-3, "_Quit") ; $GUI_EVENT_CLOSE
MouseMove((@DesktopWidth/2)-35, (@DesktopHeight/2)-20)
; Show GUI
...
Switch $nMsg
  ...
  ;_Quit()
CASE $Button2123
GuiCtrlSetData($Button2123, "exit")
  sleep(200)
 
  GuiCtrlSetData($Button2123, "EXÝT")
  ;_BlockInputEx(0)
_Quit()
EndSwitch
WEnd
