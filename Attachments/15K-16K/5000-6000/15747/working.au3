...
; Notes .........: This script works if I manualy add "WinVNC - 192.168.0.123" as the "$sVolume" variable.
;                  But I would like the script to automatically get the Lan IP address and use it in the script  
; ===============================================================================================================================
...
Global $hWnd, $iI, $iCommand, $sText, $sVolume="WinVNC - 192.168.0.123", $iIndex, $i, $lbc, $count = 1, $foo,$lines, $line, $x, $Ip, $Ifr
...
; Check if the item clicked in the listbox is the same as the highlighted item, if true move to the next line, if not loop back to (a.)
