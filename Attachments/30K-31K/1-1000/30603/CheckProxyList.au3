...
; Syntax.........: _CheckProxyList($sUrl[, $iOffset = 1[, $sDelimeter = @CRLF[, $hProgress = 0]]])
...
Func _CheckProxyList($sUrl, $iOffset = 1, $sDelimeter = @CRLF, $hProgress = 0)
