...
$clear = GUICtrlCreateButton("Clear",10,40,70,25)
$button = GUICtrlCreateButton("Ping",10,70,70,25)
$input = GUICtrlCreateInput("Enter an IP or URL",100,50,150,23)

$CLOSE = GUICtrlCreateButton("CLOSE",10,100,100,25)
...
While 1
	 Switch GUIGetMsg()
		...
		Case $clear
				...
				GUICtrlCreateInput("Enter an IP or URL",100,50,150,23)
