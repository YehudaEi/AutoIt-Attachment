...
; displays in msg box
msgbox(48, "PC Stats", $cpu & @crlf & @osversion & " Build " & @OSBuild & " " & $servpackversion & @CRLF & "Drive space free    c:/  " & $drfreef & @crlf & "Total Drive space   c:/  " & $drtotalf & @crlf & "Free physical memory = " & $memfree & " MB" & @crlf & "Total physical memory = " & $memtotal & " MB" & @crlf & $vidcard & @crlf & $soundcard & @crlf & $mouse & @crlf & $monitor)

; asks if you want to copy to clipboard
$answer = msgbox(4, "PC Stats", "Would you like to copy PC Stats to clipboard?")
If $answer = 6 Then
clipput ($cpu & @crlf & @osversion & " Build " & @OSBuild & " " & $servpackversion & @CRLF & "Drive space free    c:/  " & $drfreef & @crlf & "Total Drive space   c:/  " & $drtotalf & @crlf & "Free physical memory = " & $memfree & " MB" & @crlf & "Total physical memory = " & $memtotal & " MB" & @crlf & $vidcard & @crlf & $soundcard & @crlf & $mouse & @crlf & $monitor)
endif
