...
$Form1 = GUICreate("Daoc Chat Log Parser 0.1.1", 361, 37, 191, 125, BitOR($WS_CAPTION,$WS_BORDER,$WS_CLIPSIBLINGS))
...
While 1
	...
	If TimerDiff($checktime) >= 1000 Then
		$linesPerSec = $CurrentLine - $oldCurrentLine
	...
	ToolTip("At line: " & $CurrentLine & " Total Lines to read: " & $TotalLines & " Reading at " & $linesPerSec & " lines per second." & " sExp: " & $sExp,0,0)
