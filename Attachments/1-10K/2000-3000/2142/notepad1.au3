...
$answer = MsgBox(4, "AutoIt Example (Dutch Only)", "This script will run Notepad type in some text and then quit.  Run?")
...
WinWaitActive("Kladblok", "Nee")
Send("n")


; Now wait for Notepad to close before continuing
WinWaitClose("Naamloos - Kladblok")
