...
$AboutWin=GUICreate("About Phone v3.0 (Beta)",200,200,-1,-1,-1,$WS_EX_TOOLWINDOW,$MsgWin)
GUICtrlCreateLabel("Phone Message 3.0 (Beta) ©2005 by Michael Garrison (michael@garrison.net)",5,5,190,30)
GUICtrlCreateLabel("This program is licenced as freeware, but may not be be modified, reverse-engineered, decompiled or sold.",5,45,190,60)
GUICtrlCreateLabel("Thanks to Jonathan Bennett and the AutoIt Team. (hiddensoft.com)",5,95,190,60)
GUICtrlCreateLabel("No warrantees or guarantees are expressed or implied, except that this program is virus- and spyware-free.",5,135,190,30)
$AboutOK=GUICtrlCreateButton("OK",90,175)
