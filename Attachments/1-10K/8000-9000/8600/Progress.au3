...
;				   $s_control($progress var), $s_main(Main text), $s_sub(Sub Text), $x(Position), $y(Position)
...
;===============================================================================
;
Func _ProgressOn(ByRef $s_mainlabel, ByRef $s_sublabel, ByRef $s_control, $s_main, $s_sub, $x, $y)
	...
	$s_control = GUICtrlCreateProgress($x, $y + 30, 260, 20)
	If $s_control = 0 Then
		SetError(1)
		Return 0
	EndIf
