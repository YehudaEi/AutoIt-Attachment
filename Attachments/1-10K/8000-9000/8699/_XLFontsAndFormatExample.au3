;_XLFontsAndFormatExample.au3 0_2
...
_XLSetHorizontalAlign($FilePath,1,$XLRange,1,"Left",1) 
MsgBox(0,"","_XLSetHorizontalAlign="&"Left")
_XLSetHorizontalAlign($FilePath,1,$XLRange,1,"Right",1) 
...
;Notes: ;Note. '5' is the color code
_XLSetFontType($FilePath,1,$XLRange,1,"Bold",1) 
...
;_XLSetFontType(ByRef $s_FilePath, $s_i_Sheet, $s_i_Column, $s_FontType, $s_i_Visible)
;Notes: ;Note. '5' is the color code
_XLSetFontType($FilePath,1,$XLRange,1,"Italic",1) 
