...
;===============================================================================
; Requirement(s):   Windows XP SP2(?)/ Office 2003/ AutIt3 Beta latest (currently 120)[some may work with other office versions, but not all]
...
; Author(s):        Randall  <randallc@ozemail.com.au>, Simucal <simucal@gmail.com>, DickB
...
;			_XLArrayRead($s_cFilePath,1,$s_XLArrayRange,$s_i_Visible)																	; blank range gives "UsedRange"
;			_XLArrayWrite($XLArray,$FilePath,$s_i_Sheet,$s_i_Column,$i_Row,$s_i_Visible,$s_i_Transpose)									; returns the range used by the array
...
;			_XLCopy($s_cFilePath,$s_i_Sheet,$NamedRange,$s_i_Visible)      																; $XLCopy sets range to copy for "_XLCopyTo" to run
...
;			_XLDeleteColumn(ByRef $s_FilePath, $s_i_Sheet, $i_Column = "A", $s_i_Visible = 0)
;			_XLDeleteRow(ByRef $s_FilePath, $s_i_Sheet, $i_Row = 1, $s_i_Visible = 0)
...
;			_XLGetSheetName(ByRef $s_FilePath, $s_i_Sheet = 1, $s_i_ExcelValue = "Sheet", $s_i_Visible = "NotVisible")
;			_XLLastRow($s_FilePath,$s_i_Sheet,$s_i_Visible)
;			_XLMacroRun($s_FilePath,$s_i_Sheet,$s_MacroName,$s_i_Visible)
;			_XLNameSheet(ByRef $s_FilePath, $s_i_Sheet = 1, $s_i_ExcelValue = "Sheet", $s_i_Visible = "NotVisible")
...
;			_XLSetBorders(ByRef $s_FilePath, $s_i_Sheet, $s_i_Column, $i_Row, $i_Border, $s_i_Visible) 									; Allows you to set the border lines around a cell.  Possible options are: "LeftEdge", "TopEdge", "BottomEdge", "RightEdge", "InsideVertical", "InsideHorizontal", "Left", "Right", "Top", "Bottom"
;			_XLSetCellColor(ByRef $s_FilePath, $s_i_Sheet, $s_i_Column, $i_Row, $i_CellColor, $s_i_Visible) 							; Sets a cell's background color, use in the same way as _XLSetCellFontColor
...
;			_XLSetFontType(ByRef $s_FilePath, $s_i_Sheet, $s_i_Column, $i_Row, $s_FontType, $s_i_Visible) 								; Set a cell's font type. Possible types are: bold, italic, underlined, normal
;			_XLSetHorizontalAlign(ByRef $s_FilePath, $s_i_Sheet, $s_i_Column, $i_Row, $s_Align, $s_i_Visible) 							; Set cells horizontal alignment.  Possible alignements are: "Left", "Center", and "Right"
;			_XLSheetAdd(ByRef $s_FilePath, $s_i_Sheet = 1, $s_i_ExcelValue = "Sheet", $s_i_Visible = "NotVisible")
;			_XLSheetProperties(ByRef $s_FilePath, $s_i_Visible = 0) 																	; to 2D array
;			_XLSheetProps($FilePath,$s_i_Visible)
			...
			Select
				...
				Case StringInStr($s_MEExcelCom, "SetColWidth")
					If $s_i_ExcelValue = "Autofit" Then
						...
						;.activesheet.range ($Range).Autofit
					Else
						.Application.Columns ($s_i_Column).ColumnWidth = $s_i_ExcelValue
						;.activesheet.range ($Range).ColumnWidth = $s_i_ExcelValue
					EndIf
				Case StringInStr($s_MEExcelCom, "SetCellFontName")
					If $s_i_ExcelValue <> "" Then
						...
						.activesheet.range ($Range).Font.Name = $s_i_ExcelValue
					EndIf
				Case StringInStr($s_MEExcelCom, "SetCellFontColor")
					If IsInt($s_i_ExcelValue) = 1 Then
						...
						.activesheet.range ($Range).Font.ColorIndex = $s_i_ExcelValue
					EndIf
				Case StringInStr($s_MEExcelCom, "SetCellColor")
					If IsInt($s_i_ExcelValue) = 1 Then
						;.Application.Cells ($i_Row, $s_i_Column).Interior.ColorIndex = $s_i_ExcelValue
						.activesheet.range ($Range).Interior.ColorIndex = $s_i_ExcelValue
					EndIf
				...
				Case StringInStr($s_MEExcelCom, "SetBorders")
					...
					If IsArray($a_Border) Then
						...
						$a_Border = ""
					EndIf
				Case StringInStr($s_MEExcelCom, "DeleteRow")
					.Application.Rows ($i_Row).delete
				Case StringInStr($s_MEExcelCom, "DeleteColumn")
					.Application.Columns ($s_i_Column).delete
			EndSelect
...
EndFunc   ;==>_XLSaveAsPassword
Func _XLSetFontType(ByRef $s_FilePath, $s_i_Sheet, $s_i_Column, $i_Row, $s_FontType, $s_i_Visible)
	$var = _ExcelCOM($s_FilePath, $s_i_Sheet, $s_i_Column, $i_Row, "SetFontType", "NoSave", $s_FontType, $s_i_Visible, "NOTExit", "NotLastRow", "NOTToColumn")
EndFunc   ;==>_XLSetFontType
Func _XLSetHorizontalAlign(ByRef $s_FilePath, $s_i_Sheet, $s_i_Column, $i_Row, $s_Align, $s_i_Visible)
	$var = _ExcelCOM($s_FilePath, $s_i_Sheet, $s_i_Column, $i_Row, "SetHorizontalAlign", "NoSave", $s_Align, $s_i_Visible, "NOTExit", "NotLastRow", "NOTToColumn")
EndFunc   ;==>_XLSetHorizontalAlign
...
Func _XLSheetAdd(ByRef $s_FilePath, $s_i_Sheet = 1, $s_i_ExcelValue = "Sheet", $s_i_Visible = "NotVisible")
...
;EndFunc   ;==>_BookAdd
Func _XLGetSheetName(ByRef $s_FilePath, $s_i_Sheet = 1, $s_i_ExcelValue = "Sheet", $s_i_Visible = "NotVisible")
...
EndFunc   ;==>_XLGetSheetName
Func _XLNameSheet(ByRef $s_FilePath, $s_i_Sheet = 1, $s_i_ExcelValue = "Sheet", $s_i_Visible = "NotVisible")
	Return _ExcelCOM($s_FilePath, $s_i_Sheet, 1, 1, "NameSheet", "NoSave", $s_i_ExcelValue, $s_i_Visible, "NOTExit", "", "NOTToColumn"); LastRow excel
EndFunc   ;==>_XLNameSheet
...
Func _XLSetCellColor(ByRef $s_FilePath, $s_i_Sheet, $s_i_Column, $i_Row, $i_CellColor, $s_i_Visible)
	$var = _ExcelCOM($s_FilePath, $s_i_Sheet, $s_i_Column, $i_Row, "SetCellColor", "NoSave", $i_CellColor, $s_i_Visible, "NOTExit", "NotLastRow", "NOTToColumn")
EndFunc   ;==>_XLSetCellColor
Func _XLDeleteRow(ByRef $s_FilePath, $s_i_Sheet, $i_Row, $s_i_Visible = 0)
	$var = _ExcelCOM($s_FilePath, $s_i_Sheet, "A", $i_Row, "DeleteRow", "NoSave", 1, $s_i_Visible, "NOTExit", "NotLastRow", "NOTToColumn")
EndFunc   ;==>_XLDeleteRow
Func _XLDeleteColumn(ByRef $s_FilePath, $s_i_Sheet, $s_i_Column, $s_i_Visible = 0)
	$var = _ExcelCOM($s_FilePath, $s_i_Sheet, $s_i_Column, 1, "DeleteColumn", "NoSave", 1, $s_i_Visible, "NOTExit", "NotLastRow", "NOTToColumn")
EndFunc   ;==>_XLDeleteColumn
