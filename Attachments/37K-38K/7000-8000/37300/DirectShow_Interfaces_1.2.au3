...
;~ 		global const  $sCLSID_CaptureGraphBuilder  = '{BF87B6E0-8C27-11D0-B3F0-00AA003761C5}'
	...
	;===============================================================================
		...
		;define
		global const $tagIVMRFilterConfig9 = 'SetImageCompositor hresult(ptr);' & _
			'SetNumberOfStreams hresult(dword);' & _
			'GetNumberOfStreams hresult(dword*);' & _
			'SetRenderingPrefs hresult(dword);' & _
			'GetRenderingPrefs hresult(dword*);' & _
			'SetRenderingMode hresult(dword);' & _
	...
	;===============================================================================
		...
		;define
		global const $tagIVMRMixerControl9 = 'SetAlpha(dword;float);' & _
			'GetAlpha(dword;ptr*) ;' & _
			'SetZOrder(dword;dword) ;' & _
			'GetZOrder(dword;ptr*) ;' & _
			'SetOutputRect(dword;ptr) ;' & _
			'GetOutputRect(dword;ptr*) ;' & _
			'SetBackgroundClr(dword) ;' & _
			'GetBackgroundClr(ptr) ;' & _
			'SetMixingPrefs(dword) ;' & _
			'GetMixingPrefs(ptr*) ;' & _
			'SetProcAmpControl(dword;ptr) ;' & _
			'GetProcAmpControl(dword;ptr*) ;' & _
			'GetProcAmpControlRange(dword;ptr*);'
			; GetBackgroundClr(  [in]  COLORREF *lpClrBkg   , its' not a [out] ?
	;===============================END=============================================
