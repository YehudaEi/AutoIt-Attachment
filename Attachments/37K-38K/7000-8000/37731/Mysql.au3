...
Func _MySQLConnect($sUsername, $sPassword, $sDatabase, $sServer, $sDriver = "{SQL Server}",$iport=3306);{MySQL ODBC 3.51 Driver}", $iPort=3306)
...
Return Value(s):On success returns the query result.
On failure returns 0 and sets
@error to 1	Requirement(s):Autoit3 with COM support
	Author(s):        cdid
#ce
