...
TraySetIcon("F:\scripts\AutoIt\Build Auto Installer\avistar.ico", -1)
...
Local $move = CenterWindow($Form1, "Build Auto Installer")
...
Func CB_ProductChange()
	If GUICtrlRead($CB_Product) = "Citrix HDX" Then
		...
		$1stSection = _GUIExtender_Section_Start(0, 70)
		GUICtrlCreateGroup("", 10, 10, 280, 104)
		_GUIExtender_Section_Action($1stSection + 1)
