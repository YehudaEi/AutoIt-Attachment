...
GUICreate("listview items",840,250, (@desktopwidth-840)/2,200)
GUISetBkColor (0x00E0FFFF)  ; will change background color

$listview = GUICtrlCreateListView ("col1  |col2|col3  |col4 ",10,10,600,150)

;msgbox(0,"","number of lines: "& $PatchArr[0] & " ubound: " & ubound($Patcharr,1))
...
If IsObj($ObjNodeList) Then
 ...
 MsgBox (0,"","Number of bulletins: " & $objNodeList.length)
