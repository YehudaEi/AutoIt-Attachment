...
Global $gmap, $geocode_line, $bounds
...
; Syntax.........:	_GUICtrlGoogleMap_Create(ByRef $gmap, $left, $top, $width, $height, $address, $zoom = 8, $marker = 1, $streetview = True, $overview_map = false, _
;												   $map_type = 0, $navigation_style = 0, $zoom_style = 0, $map_type_style = 0, $scale = 0, $lang = "en", $weather_unit = "C")
...
;					$zoom_style			- 0 = Disable the Zoom control
;									  	  1 = Enable the Zoom control with a small style
;									  	  2 = Enable the Zoom control with a large style
;									  	  3 = Enable the Zoom control with a default style
...
;					$scale				- 0 = Disable the Scale control
...
; Link ..........:
; ;==========================================================================================
Func _GUICtrlGoogleMap_Create(ByRef $gmap, $left, $top, $width, $height, $address, $zoom = 8, $marker = 1, $streetview = True, $overview_map = False, $map_type = 0, _
									$navigation_style = 0, $zoom_style = 0, $map_type_style = 0, $scale = 0, $lang = "en", $weather_unit = "C")
	Local $gmap_ctrl, $onload_marker_options, $weather_unit_options
	...
	Local Const $zoom_style_html[4] = [ _
		"zoomControl: false, ", _
		"zoomControl: true, zoomControlOptions: {style: google.maps.ZoomControlStyle.SMALL}, ", _
		"zoomControl: true, zoomControlOptions: {style: google.maps.ZoomControlStyle.LARGE}, ", _
		"zoomControl: true, zoomControlOptions: {style: google.maps.ZoomControlStyle.DEFAULT}, "]
	Local Const $map_type_style_html[4] = [ _
		"mapTypeControl: true, ", _
	...
	Local Const $scale_html[2] = [ _
		"scaleControl: false, ", _
		"scaleControl: true, "]
	Local $latlng[2]
	...
	"<html>" & @CRLF & _
	"<head>" & @CRLF & _
	"    <title>Google Maps JavaScript API v3: Directions Draggable</title>" & @CRLF & _
	"    <meta name=""viewport"" content=""initial-scale=1.0, user-scalable=no"">" & @CRLF & _
	"    <meta http-equiv=""X-UA-Compatible"" content=""IE=8; charset=UTF-8"">" & @CRLF & _
	...
	If $country = True Then
		...
		"            " & $scale_html[$scale] & @CRLF & _
		"            " & $zoom_style_html[$zoom_style] & @CRLF & _
		...
		"        zoomLevel = setTimeout(function() {map.getZoom()}, 250);" & @CRLF & _
		"    }" & @CRLF
	Else
		Local $html1b = _
		"        var myOptions = {" & @CRLF & _
