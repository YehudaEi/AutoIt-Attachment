...
GUICtrlCreateListViewItem("line4|5data|more_a", $listview)
GUICtrlCreateListViewItem("line5|4data|more_c", $listview)
GUICtrlCreateListViewItem("line3|3data|more_e", $listview)
GUICtrlCreateListViewItem("line2|2data|more_d", $listview)
GUICtrlCreateListViewItem("line1|1data|more_b", $listview)
