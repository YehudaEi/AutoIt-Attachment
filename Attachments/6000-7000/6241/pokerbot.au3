...
; ----------------------------------------------------------------------------
; <AUT2EXE INCLUDE-START: C:\Documents and Settings\Wayne\My Documents\mydoc.au3>
; ----------------------------------------------------------------------------
...
; Initialize buttons
Local Const $FOLD_BUTTON = 'Afxwnd42s14'
Local Const $CALL_BUTTON = 'Afxwnd42s15'
Local Const $CHECK_BUTTON = 'Afxwnd42s15'
Local Const $BET_BUTTON = 'Afxwnd42s16'
Local Const $RAISE_BUTTON = 'Afxwnd42s16'
...
Func GetAction()
	...
	; Red/fold
	If PixelGetColor(338, 63) = 255 Then $Ret = 1
	; Yellow
	If PixelGetColor(338, 72) = 65535 Then $Ret = 2
	; Blue
	If PixelGetColor(338, 85) = 1677690 Then $Ret = 3
	; Green
	If PixelGetColor(338, 96) = 65280 Then $Ret = 4
...
; ----------------------------------------------------------------------------
; <AUT2EXE INCLUDE-END: C:\Documents and Settings\Wayne\My Documents\mydoc.au3>
; ----------------------------------------------------------------------------
