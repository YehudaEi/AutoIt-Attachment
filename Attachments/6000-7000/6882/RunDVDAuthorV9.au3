...
Func GenerateDVD ($TempPath, $DVDLabel, $ISO)
  ...
  WinWait ("DVD Writing Tool")
  If Not Winwaitactive ("DVD Writing Tool") Then WinActivate ("DVD Writing Tool")
  Winwaitactive ("DVD Writing Tool")
  Sleep (300)

  $DVDLabel = CleanTitle ($DVDLabel)

  ControlSetText ( "DVD Writing Tool", "", "Edit1", $DVDLabel)

  Sleep (300)

  ; Start ISO Generation
  ControlClick ( "DVD Writing Tool", "", "Button2")
  WinWait ("Specify the ISO file to generate")
  If Not WinWaitActive ("Specify the ISO file to generate") Then  WinActivate ("Specify the ISO file to generate")
  WinWaitActive ("Specify the ISO file to generate")
  Send ($ISO)
  Send ("{ENTER}")

  do
    Sleep (2000)
  until (ControlCommand ( "DVD Writing Tool", "", "Button2", "IsEnabled", "" ) = 1)

  WinWait       ("Outputting complete")
  If Not WinActive  ("Outputting complete") Then WinActivate   ("Outputting complete")
  WinWaitActive ("Outputting complete")

  ; Start DVD Writing Tool
  ControlClick ( "Outputting complete", "", "TPGSkinButton1")

  WinWait          ("DVD Writing Tool")
  If Not WinActive ("DVD Writing Tool") Then WinActivate  ("DVD Writing Tool")
  WinWaitActive    ("DVD Writing Tool")
  ...
  do
    Sleep (2000)
  Until WinExists ("DVD Writing Tool", "The ISO file has been created.")

  If Not WinActive ("DVD Writing Tool", "The ISO file has been created.") Then WinActivate ("DVD Writing Tool", "The ISO file has been created.")
  WinWaitActive    ("DVD Writing Tool", "The ISO file has been created.")
  ControlClick     ("DVD Writing Tool", "The ISO file has been created.", "Button1")
  WinWaitClose     ("DVD Writing Tool", "The ISO file has been created.")

  Sleep (500)
  Send ("!{F4}")

  WinWait       ("Select", "This will close the program.")
  WinActivate   ("Select", "This will close the program.")
  WinWaitActive ("Select", "This will close the program.")
  ControlClick  ("Select", "", "Button1")
EndFunc
; ----------------------------------------------------------------------------
