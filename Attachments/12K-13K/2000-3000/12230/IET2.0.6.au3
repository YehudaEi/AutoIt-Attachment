...
#cs
	...
	Requirements: AutoIt3 3.2 or higher, Developed/Tested on WindowsXP Pro with Internet Explorer6
	...
	New Features
	_IEPropertyGet() - added referrer, theatermode and toolbar, contenteditable, innertext, outertext, innerhtml, outerhtml
	_IEPropertySet() - added theatermode and toolbar, contenteditable, innertext, outertext, innerhtml, outerhtml
...
Global Const $IEAU3VersionInfo[6] = ["T", 2, 0, 6, "20061130", "T2.0-6"]
...
;===============================================================================
;
Func _IENavigate(ByRef $o_object, $s_Url, $f_wait = 1, $i_flags = 0, $s_target = "", $s_postdata = "", $s_headers = "")
	If Not IsObj($o_object) Then
...
Func _IEAttach($s_string, $s_mode = "Title")
	...
	Local $h_control, $oResult, $f_isBrowser, $s_tmp, $o_tmp
	...
	For $o_window In $o_ShellWindows
		...
		EndIf
		If $f_isBrowser Then
			$s_tmp = $o_window.document.title ; Does object have a .document and .title prpperty?
			If @error Then $f_isBrowser = False
		EndIf
	...
	Switch ObjName($o_object)
		...
		Case "DispHTMLWindow2" ; Window, Frame, iFrame
			Do
				...
				If @error = $_IEStatus_ComError And ($IEComErrorNumber = 169  Or $IEComErrorNumber = -2147352567 Or String($IEComErrorDescription) = "Access is denied.") Then
...
Func _IE_Introduction($s_module = "basic")
	...
	Switch $s_module
		Case "basic"
			...
			$s_html &= "<a href='http://search.msdn.microsoft.com/search/Redirect.aspx?title=InternetExplorer+Object+(Internet+Explorer+-+WebBrowser)"
			$s_html &= "&url=http://msdn.microsoft.com/workshop/browser/webbrowser/reference/objects/internetexplorer.asp'>Internet Explorer Object Model</a> and the " & @CR
