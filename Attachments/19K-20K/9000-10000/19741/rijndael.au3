...
;
;===============================================================================
Func _rndCipher($key, $message, $BlockSize = 128, $mode = 0, $iv = '', $padding = 0)
	Switch $BlockSize
...
;
;===============================================================================
Func _rndInvCipher($key, $message, $BlockSize=128, $mode = 0, $iv = '', $padding = 0)
	Switch $BlockSize
		Case 128, 160, 192, 224, 256
		Case Else
			Return SetError(1,0,0)
	...
	If $mode < 2 Then
		...
		EndSwitch
	EndIf
	$result_ascii = BinaryToString($result)
	Return $result_ascii
EndFunc
