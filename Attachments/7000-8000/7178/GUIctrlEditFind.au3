...
;
;===============================================================================
Func _GuiCtrlEditFind(ByRef $h_gui, ByRef $h_edit, $b_replace = False)
   ...
   While 1
      ...
      Select
         ...
         Case $msg_find = $btn_FindNext
            _FindText($h_edit, $Input_Search, $chk_matchcase, $chk_wholeonly, $pos, $occurance)
...
;
;===============================================================================
Func _FindText(ByRef $h_edit, ByRef $Input_Search, ByRef $chk_matchcase, ByRef $chk_wholeonly, ByRef $pos, ByRef $occurance)
