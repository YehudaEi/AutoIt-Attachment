...
;#=#ChangeLog#==================================================================#
;#  v 2.0  Changed GUI to Show Bug Report - based on Jenico's original script dated 04 09 2008
;#  v 2.1. Changed GUI Size to minimise wasted space below Edit Box
;#  v2.1.1 Changed Event Control to Switch Case statement to make it look easier.
		...
		While 1
			...
			Switch $msg 
					...
					Case $cont 
						ContinueCase
					Case $con 
						MsgBox(270400,"Continue Application", _
					...
					Case $res 
						If @Compiled Then
							$x=Run(@ScriptName)
						Else
							$x=Run('"Autoit3.exe" "'&@ScriptFullPath&'"') ; $x=Run("Autoit3.exe "&@ScriptFullPath)
						EndIf
