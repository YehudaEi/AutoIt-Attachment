...
Func main()
	...
	While 1
		...
		Select
			Case $msg = $export
				If $var = 1 Then
					MsgBox(0, "Error", "Nothing to export.")
				Else
					...
					$oExcel.ActiveSheet.Name = "Call List"
					$oExcel.ActiveSheet.PageSetup.CenterHeader = "Call List"
					$oExcel.ActiveSheet.PageSetup.LeftFooter = "Regcall v1.0"
					$oExcel.ActiveSheet.PageSetup.RightFooter = "By Vincent Willems"
