...
;-----------Names-----------
$NameList = _ArrayCreate(3, "Dath", "Gar", "Ash")
$NameList1 = _ArrayCreate(2, "rem", "or")
$NameList2 = _ArrayCreate(2, "nar", "ar")
;-----------Names-----------
...
$Generate = GUICtrlCreateButton("Generate", 208, 76, 107, 25, 0)
...
While 1
	...
	Switch $nMsg
		...
		Case $Generate
			GUICtrlSetData($Name, $NameList[Random(1, 3, 1) ] & $NameList1[Random(1, 2, 1) ] & $NameList2[Random(1, 2, 1) ]) ; Generates a random name from the array list
