...
For $i = 0 To 99
	$read = IniReadSection("MoveTool History.ini",$asection[$I])
	if @error then 
		iniwrite ("MoveTool History.ini",$asection[$I],"File",  $from )
		iniwrite ("MoveTool History.ini",$asection[$I],"File destination" ,  $to )
		ExitLoop
	EndIf
Next
EndFunc ;_History
...
Func _OpenHistory ()
ShellExecute("MoveTool History.ini")
if @error Then
...
func _ReadDialogto ()
	$to = FileSelectFolder ( "Choose folder", "")
