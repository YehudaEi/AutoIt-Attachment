...
;					 [23] Pen (grid) Handle
; =======================================================================================
Func _GraphGDIPlus_Create($hWnd, $iLeft, $iTop, $iWidth, $iHeight, $hColorBorder = 0xFF3F3F3F, $hColorFill = 0xFFFFFFFF, $iSmooth = 2)
...
Func _GraphGDIPlus_Set_RangeY(ByRef $aGraphArray, $iLow, $iHigh, $iYTicks = 1, $bLabels = 1, $iRound = 0)
	...
	For $i = 1 To $iYTicks + 1
		...
		$ahTicksLabelsY[$i] = GUICtrlCreateLabel("", $aGraphArray[2] - 60, _
				($aGraphArray[3] + $aGraphArray[5]) - (($aGraphArray[5] / $iYTicks) * ($i - 1)) - 6, 50, 13, 2)
		;GUICtrlSetBkColor(-1, -2)
		GUICtrlSetColor(-1, 0xFFFFFF)
	Next
	;----- if labels are required, then fill -----
...
Func _GraphGIDPlus_Plot_Text(ByRef $aGraphArray, $iX, $iY, $iText, $iColor, $iSize2, $iFont)
	If IsArray($aGraphArray) = 0 Then Return
	$iX = _GraphGDIPlus_Reference_Pixel("x", $iX, $aGraphArray[6], $aGraphArray[7], $aGraphArray[4])
	$iY = _GraphGDIPlus_Reference_Pixel("y", $iY, $aGraphArray[8], $aGraphArray[9], $aGraphArray[5])
	$hBrush2 = _GDIPlus_BrushCreateSolid ($iColor)
	$hFormat = _GDIPlus_StringFormatCreate ()
	$hFamily = _GDIPlus_FontFamilyCreate ($iFont)
	$hFont = _GDIPlus_FontCreate ($hFamily, $iSize2, 1)
	$tLayout = _GDIPlus_RectFCreate ($iX, $iY, 150, 15)
	_GDIPlus_GraphicsDrawStringEx ($aGraphArray[1], $iText, $hFont, $tLayout, $hFormat, $hBrush2)

EndFunc ;==>_GraphGIDPlus_Plot_Text
...
; =======================================================================================
Func _GraphGDIPlus_Set_GridX(ByRef $aGraphArray, $Ticks = 1, $hColor = 0xFFf0f0f0, $hColorY0 = 0xFF3F3F3F)
	If IsArray($aGraphArray) = 0 Then Return
...
; =======================================================================================
Func _GraphGDIPlus_Set_GridY(ByRef $aGraphArray, $Ticks = 1, $hColor = 0xFFf0f0f0, $hColorX0 = 0xFF3F3F3F)
	If IsArray($aGraphArray) = 0 Then Return
	;----- Set gpen to user color -----
	_GDIPlus_PenSetColor($aGraphArray[23], $hColor)
	;----- draw grid lines -----
