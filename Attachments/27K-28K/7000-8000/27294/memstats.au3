...
Func MemStats()
	...
	$frmMemStats = GUICreate("Memory Status", 588, 330)
	...
	$reducemem = GUICtrlCreateButton("Reduce Memory Usage",15,220,150,20)
	$closemem = GUICtrlCreateButton("Close", 15, 250, 150, 20)
	
	GuiSetState(@SW_SHOW, $frmMemStats)
	...
	While 1
		...
		Switch $nMsg
			...
			Case $GUI_EVENT_MINIMIZE
				GUISetState(@SW_HIDE, $frmMemStats)
