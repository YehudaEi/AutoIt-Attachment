;===============================================================================
;
; Description:      Returns the exitcode based on .
; Syntax:           _Getcode($Exitcode)
; Parameter(s):     $Exitcode - The exit code generated from the Runwait command
; Requirement(s):   None
; Return Value(s):  On Success - Returns the relevant error code
; Author(s):        Lyle de Groot
; Notes:			- Codes retrived from                                                      
;					- Custom codes can be added to this script and read
;===============================================================================
