...
; ----------------------------------------------------------------------------
; <AUT2EXE INCLUDE-START: C:\Documents and Settings\Addi\Desktop\chestii la care lucrez\ceas.au3>
; ----------------------------------------------------------------------------

; Script generated by Mikidutza
...
$fereastra = GuiCreate("Mikidutza",115,32,@DesktopWidth / 2 - 57.5, 0, $WS_POPUP)

	$Label_1 = GUICtrlCreateLabel(_NowTime(5), 0, 0, 120, 32,$SS_NOTIFY)
GUIctrlSetOnEvent(-1,"clic")	
	GUICtrlSetFont (-1,26, 400, 0, $font)
	GUICtrlSetColor(-1,0xff0000)
	GUICtrlSetBkColor(-1,0x000000)
GuiSetState()

WinSetOnTop("Mikidutza","",1)
While 1
	sleep(1000)
	GUICtrlSetData($Label_1,_NowTime(5))
	$msg = GUIGetMsg()
WEnd
Exit

Func clic()
			$mes = MsgBox(4,"Clock","Do you want to exit?")
		If $mes = "6" Then
			Exit
		EndIf
EndFunc
...
; ----------------------------------------------------------------------------
; <AUT2EXE INCLUDE-END: C:\Documents and Settings\Addi\Desktop\chestii la care lucrez\ceas.au3>
; ----------------------------------------------------------------------------
