...
func EnumProcesses($pdwProcessIds, $dwcb, $pdwBytesReturned) ;returns BOOL
	...
	return dllcall("kernel32.dll", "BOOL", "EnumProcesses", "ptr", $pdwProcessIds, "DWORD", $dwcb, "ptr", $pdwBytesReturned)
endfunc
...
func GetModuleInformation($hProcess, $hModule, $lpmodinfo, $dwcb) ;returns BOOL
	...
	return dllcall("kernel32.dll", "BOOL", "GetModuleInformation", "HANDLE", $hProcess, "HANDLE", $hModule, "ptr", $lpmodinfo, "DWORD", $dwcb) 
endfunc
...
func EnumProcessModulesEx($hProcess, byref $lphModule, $dwcb, byref $lpdwcbNeeded, $dwFilterFlag) ;returns BOOL
	;http://msdn.microsoft.com/en-us/library/windows/desktop/ms682633%28v=vs.85%29.aspx
	return dllcall("kernel32.dll", "BOOL", "EnumProcessModulesEx", "HANDLE", $hProcess, "HANDLE*", $lphModule, "DWORD", $dwcb, "DWORD*", $lpdwcbNeeded, "DWORD", $dwFilterFlag) 
endfunc
...
func GetProcessMemoryInfo($hProcess, $ppsmemCounters, $dwcb) ;returns BOOL
	...
	return dllcall("kernel32.dll", "BOOL", "GetProcessMemoryInfo", "HANDLE", $hProcess, "ptr", $ppsmemCounters, "DWORD", $dwcb) 
endfunc
...
func EnumPageFiles($pCallbackRoutine, $lpContext) ;returns BOOL
	...
	return dllcall("kernel32.dll", "BOOL", "EnumPageFiles", "HANDLE", $hProcess, "ptr", $lpContext) 
endfunc
func EnumPageFilesProc($pContext, $pPageFileInfo, $lpFilename) ;returns BOOL
	...
	;if (1==@AutoItX64) then
		return dllcall("kernel32.dll", "BOOL", "EnumPageFilesProc", "HANDLE", $hProcess, "ptr", $lpContext, "wstr", $lpFilename)
	;else
	;	return dllcall("kernel32.dll", "BOOL", "EnumPageFilesProc", "HANDLE", $hProcess, "ptr", $lpContext, "str", $lpFilename)
	;endif
endfunc
#comments-end
