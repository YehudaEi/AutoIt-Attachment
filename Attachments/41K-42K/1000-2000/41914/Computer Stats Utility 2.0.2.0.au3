...
GUICtrlCreateLabel("RAM Usage:", 10, 25, 270, 15)
$RAM = GUICtrlCreateProgress(120, 25, 245, -1, 0x01)
$RAMLabel = GUICtrlCreateLabel("", 370, 30, 30, 15)
GUICtrlCreateLabel("Avg. RAM Usage:", 10, 50, 270, 15)
$AvgRAMBar = GUICtrlCreateProgress(120, 50, 245, -1, 0x01)
$AvgRAMLabel = GUICtrlCreateLabel("", 370, 55, 30, 15)
GUICtrlCreateLabel("Total RAM:", 10, 75, 270, 15)
GUICtrlCreateInput(Round($RAMUsage[1] / 1048576, 2) & " GB", 105, 75, 290, 20, 0x0801)
GUICtrlCreateLabel("Memory Type:", 10, 100, 270, 15)
GUICtrlCreateInput($MemoryType, 105, 100, 290, 20, 0x0801)
GUICtrlCreateLabel("Total Virtual:", 10, 125, 270, 15)
GUICtrlCreateInput(Round($RAMUsage[3] / 1048576, 2) & " GB", 105, 125, 290, 20, 0x0801)
GUICtrlCreateTab(-1, -1, 400, 419)
