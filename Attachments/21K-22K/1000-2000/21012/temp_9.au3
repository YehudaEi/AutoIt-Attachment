#include <String.au3>
$String = "asgweg嘎洒好人啊耳机 test"
$Key = "Password"
$flag = 4

;console output test of the string
ConsoleWrite($String& @CRLF)
$buffer = StringToBinary($String, 4)
ConsoleWrite("binary representation: " & $buffer & @CRLF)
ConsoleWrite("binary length: " & BinaryLen($buffer) & @CRLF)
$buffer = BinaryToString($buffer, 4)
ConsoleWrite("string representation: " & $buffer & @CRLF)		;display is correct
ConsoleWrite("string length: " & StringLen($buffer) & @CRLF)	;number is correct for string containing Asian characters


;encryption/decryption tests
$encodedstr = __StringEncrypt(1, $String, $Key,3,$flag)
$decodedstr = __StringEncrypt(0, $encodedstr, $Key,3,$flag)

ConsoleWrite('@@ _StringEncrypt(1, $string, $key ) = ' & $encodedstr & @CRLF & '>Error code: ' & @error & @CRLF);
ConsoleWrite('@@ _StringEncrypt(1, $string, $key ) = ' & $decodedstr & @CRLF & '>Error code: ' & @error & @CRLF);
