...
Func _CreateBorderLabel2($sText, $iX, $iY, $iW, $iH, $iColor, $iPenSize = 1)
	_GDIPlus_GraphicsDrawRect($hGraphics, $iX - $iPenSize, $iY - $iPenSize, $iW + 2 * $iPenSize, $iH + 2 * $iPenSize, $iColor)
	_GDIPlus_GraphicsDrawString($hGraphics, $sText, $iX, $iY, "Arial", 9)
EndFunc   ;==>_CreateBorderLabel
