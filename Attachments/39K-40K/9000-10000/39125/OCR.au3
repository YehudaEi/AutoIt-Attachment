...
#CS
	...
	learnFonts() - displays the characters in a autoit window then uses the OCR to automatically learn them
	...
	OPTIONS (documented from approx line 122)
...
Func _OCR($left, $top, $right, $bottom, $searchColour = 0x000000, $searchColourVariation = 100, $fontFile = "", $ocrTrainChar = "", $ocrOptions = 1)
