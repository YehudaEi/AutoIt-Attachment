...
Func _SoundPlay($aSndID, $iWait = 0)
	...
	If Not __SoundChkSndID($aSndID, True) Then Return SetError(3, 0, 0) ; invalid Sound ID or file name
	...
	If $iExtended = 13 Then
		Local $iRet = __SoundFindFree()
		If $iRet <> -13 Then
			$__SOUNDTEMPMEM[$iRet] = $aSndID
			AdlibRegister("__SoundCloseAutoOpened", 1000)
		Else
...
; Example .......:
; ===============================================================================================================================
Func __SoundCloseAutoOpened()
	Local $iNotSkipped = 0
	For $i = 0 To UBound($__SOUNDTEMPMEM) -1
		If $__SOUNDTEMPMEM[$i] = "" Then ContinueLoop
		$iNotSkipped += 1
		$iRet = _SoundStatus($__SOUNDTEMPMEM[$i])
		If @error Then ContinueLoop
		If $iRet = "stopped" Then
			_SoundClose($__SOUNDTEMPMEM[$i])
			$__SOUNDTEMPMEM[$i] = ""
		EndIf
	Next
	If $iNotSkipped = 0 Then AdlibUnRegister("__SoundCloseAutoOpened")
EndFunc   ;==>__SoundChkSndID

; #INTERNAL_USE_ONLY# ===========================================================================================================
; Name...........: __SoundFindFree
; Description ...: Used internally within this file, not for general use
; Syntax.........: __SoundFindFree()
; Author ........: Alexander Samuelsson (AdmiralAlkex)
; Modified.......:
; Remarks .......:
; Related .......:
...
; Example .......:
; ===============================================================================================================================
Func __SoundFindFree()
	For $i = 0 To UBound($__SOUNDTEMPMEM) -1
		If $__SOUNDTEMPMEM[$i] = "" Then
			Return $i
		EndIf
	Next
	Return -13
...
; Author ........: jpm
; Modified.......: Melba23, AdmiralAlkex
; Remarks .......:
; Related .......:
; Link ..........:
; Example .......:
; ===============================================================================================================================
Func __SoundChkSndID(ByRef $aSndID, $iInternal = False)
	If Not IsArray($aSndID) Then
		If Not FileExists($aSndID) Then Return 0 ; invalid Sound file
		If $iInternal <> True Then
