...
$oOutputFormat = ObjCreate("MSUtil.LogQuery.XMLOutputFormat")  ; XML
...
$StrQuery = "SELECT TOP 25 EXTRACT_TOKEN( Text, 4, ' ' ) As Src-IP, Count(*) INTO " &@ScriptDir &"\Report.xml FROM " &@WindowsDir&"\Pfirewall.log "& _
